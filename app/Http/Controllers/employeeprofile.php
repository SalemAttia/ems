...
class employeeprofile extends Controller
{
    ...
    public function index()
    {
       ...
       $constraints = [
        ...
        return view('employeeprofile/index', ['employees' => $employees,'new' => $new]);
    }
    ...
    public function create()
    {
        ...
        $new = 'موظف جديد';
        return view('employeeprofile/create', ['cities' => $cities, 'states' => $states, 'countries' => $countries,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('/employeeprofile');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('/employeeprofile'.'/'.$id);
    }
